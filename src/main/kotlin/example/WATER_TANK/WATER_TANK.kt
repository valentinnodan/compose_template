...
fun WaterTank(registry: ConnectionFieldRegistry){
    ...
    Box {
        ...
        PositionedBox(@Composable { Figure(RoundedCornerShape(100.dp), modifier = Modifier.size(200.dp, 300.dp).background(brush = METALLIC_BRUSH, shape = RoundedCornerShape(20.dp)))}, 200, 150, zIndex = 2f)
        PositionedBox(@Composable{Pipe(Color.Gray, 100.dp, 30.dp)}, 400, 400)
        PositionedBox(@Composable{ VerticalIndicator("tankIndicator", "225.0.0.1", 65002, registry,
            color = Color.Blue, step = 20f, minTemperature = 0f, maxTemperature = 100f,
        trackHeight = 200.dp, indicatorWidth = 20.dp)}, 300, 200, zIndex = 3f)
    }
}
...
fun LampIndicator(name: String, host: String, port: Int, registry: ConnectionFieldRegistry, pipeSize: Dp = 30.dp) {
    Row {
        PositionedBox(@Composable{Bulb(name, host, port, registry, size = pipeSize, borderWidth = 4.dp, modifier = Modifier.zIndex(2f))}, pipeSize.value / 2)
...
fun System(registry: ConnectionFieldRegistry) {
    ...
    PositionedBox(@Composable{ VerticalIndicator("outputIndicator", "225.0.0.1", 65003, registry,
        ...
        trackHeight = 200.dp, indicatorWidth = 20.dp)}, 440, 150, zIndex = 3f)
    PositionedBox(@Composable{ LightingText("stateInlet", "225.0.0.1", 65005, registry, "Inlet", width = 70.dp, height = 25.dp, borderWidth = 5.dp) }, 500, 150)
    PositionedBox(@Composable{ LightingText("stateHeat", "225.0.0.1", 65006, registry, "Heat", width = 70.dp, height = 25.dp, borderWidth = 5.dp) }, 500, 200)
    PositionedBox(@Composable{ LightingText("stateOutlet", "225.0.0.1", 65007, registry, "Outlet", width = 70.dp, height = 25.dp, borderWidth = 5.dp) }, 500, 250)
}